        ...
        <div style={{ padding: '0.85rem 1rem', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              background: '#ff4444', border: '1.5px solid rgba(22,20,35,0.97)',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.25rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                <span style={{ fontSize: '0.62rem', fontWeight: '700', letterSpacing: '1.2px', textTransform: 'uppercase', color: 'rgba(255,255,255,0.35)' }}>
                  {count === 1 ? 'New Sale' : 'New Sales'}
                </span>
                <span style={{
                  width: '5px', height: '5px', borderRadius: '50%', background: '#51cf66',
                  display: 'inline-block', animation: 'live-pulse 1.6s ease-in-out infinite',
                }} />
              </div>
              <button onClick={handleClose}
                style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'rgba(255,255,255,0.18)', fontSize: '0.95rem', lineHeight: 1, padding: 0, display: 'flex', alignItems: 'center' }}
            ...
            {/* Main message */}
            <div style={{ fontSize: '0.86rem', fontWeight: '700', color: 'rgba(255,255,255,0.9)', marginBottom: '0.2rem', letterSpacing: '-0.1px' }}>
              You have {count} new {count === 1 ? 'notification' : 'notifications'}
            </div>

            {/* CTA */}
            <div style={{ fontSize: '0.72rem', color: 'rgba(232,119,34,0.7)', fontWeight: '600', letterSpacing: '0.2px' }}>
