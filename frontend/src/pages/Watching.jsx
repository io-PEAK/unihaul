    ...
    <div className="page-transition">
                    ...
                    >
                      <div
                        ...
                        style={{
                          ...
                          transform:
                            isHovered || isSelected ? "scale(1)" : "scale(0.7)",
                          transition: "all 0.2s ease",
                          cursor: "pointer",
                        }}
                      >
                        ...
                        >
                          ...
                          {w.priceHistory?.[0] && (
                            ...
                            >
                              ...
                              >
                                {Math.round(
                                  ((w.priceHistory[0].oldPrice - w.item.price) /
                                    w.priceHistory[0].oldPrice) *
                                    100,
                                )}
                                %
                              </span>
                      ...
                      >
                        <button
                          ...
                          style={{
                            ...
                            borderRadius: "10px",
                            background: expandedIds.has(w.item.id)
                              ? "var(--bg-surface)"
                              : "var(--bg-card)",
                            border: "1px solid var(--border)",
                            color: expandedIds.has(w.item.id)
                              ? "var(--accent)"
                              : "var(--text-muted)",
                            fontSize: "0.78rem",
                            fontWeight: "700",
                        ...
                        >
                          <svg
                            ...
                            strokeWidth="2.5"
                            style={{
                              transform: expandedIds.has(w.item.id)
                                ? "rotate(180deg)"
                                : "none",
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      padding: "1rem",
                      boxShadow: isSelected
                        ? "0 15px 35px rgba(var(--accent-rgb),0.2)"
                        : isHovered
                            ...
                            {w.priceHistory.map((h, i) => (
                              <div
                                ...
                                style={{
                                  ...
                                  gap: "0.6rem",
                                  marginBottom:
                                    i === w.priceHistory.length - 1 ? 0 : "6px",
                                }}
                              >
                                <span
                                  style={{
      ...
      <style>{`
        ...
        @media (min-width: 961px) {
          .watching-header { padding-left: 48px !important; }
        }
      ...
      {bulkConfirm && (
        ...
        >
          ...
          >
            ...
            >
              You'll stop receiving price drop and status updates for these
              items.
            </p>
