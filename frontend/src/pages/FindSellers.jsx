  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: "2.5rem" }}>
        ...
        >
          Search by item name to find who's selling it — or search by name,
          institution, or city. Use both together to narrow down.
        </p>
      </div>
        ...
        >
          ...
          <div style={{ position: "relative", flex: 1, minWidth: "140px" }}>
            <svg
              ...
              fill="none"
              stroke={
                peopleQueryFocused ? "var(--accent)" : "var(--text-muted)"
              }
              strokeWidth="2.5"
              strokeLinecap="round"
              style={{
          ...
          {/* Type filter */}
          <div
            className="sellers-type-filters"
                ...
                style={{
                  ...
                  background:
                    type === t
                      ...
                      : "var(--bg-input)",
                  color: type === t ? "var(--accent-alt)" : "var(--text-muted)",
                  fontSize: "0.84rem",
