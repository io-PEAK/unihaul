    ...
    if (!draggable) {
      ...
      try {
        const saved = JSON.parse(
          localStorage.getItem("drag_backbtn_sellerprofile"),
        );
        if (saved)
          ...
          try {
            ...
            if (hasAccepted) {
              ...
              const existing = sent.find(
                (r) => r.receiverId === parseInt(id) && r.itemId === null,
              );
  ...
  useEffect(() => {
    ...
    import("../socket")
      .then(({ connectSocket }) => {
        ...
        const onAccepted = () =>
          setRequestStatus((s) => (s === "pending" ? "accepted" : s));
        const onDeclined = () =>
          setRequestStatus((s) => (s === "pending" ? "declined" : s));
  ...
  async function handleSendRequest() {
    ...
    try {
      ...
      if (err.response?.data?.cooldown) {
        ...
        setRequestError(
          `Request was declined. You can try again in ${h} hour${h !== 1 ? "s" : ""}.`,
        );
      } else {
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        <div style={{ position: "relative", marginBottom: "2.5rem" }}>
          ...
          >
            ...
            {soldItems.length} sold · {reviews.length} review
            {reviews.length !== 1 ? "s" : ""}
          </p>
        </div>
                  ...
                  >
                    <div
                      style={{
                        ...
                        borderRadius: "50%",
                        background: "#ffd43b",
                        boxShadow: "0 0 6px rgba(255,212,59,0.6)",
                      }}
                    />
                    Request Pending
                  </div>
            ...
            <div
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.background =
                  "linear-gradient(135deg, rgba(var(--accent-rgb),0.1) 0%, rgba(var(--accent-rgb),0.04) 100%)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.border =
        ...
        >
          <div
            ...
            style={{
              ...
              animation:
                "panelSlideUp 0.35s cubic-bezier(0.175, 0.885, 0.32, 1.275)",
            }}
          >
            <div
              style={{
            ...
            <div
              ...
              style={{ overflowY: "auto", flex: 1, padding: "1.25rem 1.5rem" }}
            >
              {activeTab === "listings" &&
                (listings.length === 0 ? (
                  <div
      ...
      {showRequestModal && (
        ...
        >
          ...
          >
            ...
            >
              Send a chat request to {user.firstName}. They can accept or
              decline.
            </p>
            <div style={{ marginBottom: "1rem" }}>
              ...
              <textarea
                ...
                onFocus={(e) =>
                  (e.target.style.borderColor = "rgba(var(--accent-rgb),0.35)")
                }
                onBlur={(e) =>
            ...
            <div style={{ display: "flex", gap: "0.75rem" }}>
              ...
              <button
                ...
                style={{
                  flex: 1,
                  padding: "0.75rem",
                  background: requestLoading
                    ? "rgba(255,255,255,0.06)"
                    : "linear-gradient(135deg, var(--accent), var(--accent-alt))",
                  color: requestLoading ? "rgba(255,255,255,0.25)" : "white",
                  border: "none",
                  borderRadius: "12px",
                  cursor: requestLoading ? "not-allowed" : "pointer",
                  fontSize: "0.85rem",
                  fontWeight: "700",
                  boxShadow: requestLoading
                    ? "none"
                    : "0 4px 15px rgba(var(--accent-rgb),0.35)",
                  fontFamily: "var(--font-body)",
                  transition: "all 0.2s",
