    ...
    <div style={{
      ...
      <div style={{
            ...
            <div key={field.name} style={{ marginBottom: '1.15rem' }}>
              ...
              <input
                ...
                style={{
                  ...
                  boxSizing: 'border-box', fontWeight: '400', letterSpacing: '0.2px',
                }}
              />
              ...
              {field.name === 'email' && emailError && (
                <p style={{
                  ...
                  color: 'rgba(255,77,77,0.8)', fontWeight: '500',
                }}>
                  ⚠ {emailError}
                </p>
              )}
        ...
        <p style={{
          ...
          color: 'rgba(255,255,255,0.3)', fontSize: '0.85rem', fontWeight: '400',
        }}>
