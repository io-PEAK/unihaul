...
function Messages() {
  ...
  return (
    <div className="msgs-page" style={{ height: 'calc(100vh - 65px)', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
      <style>{`
      ...
      <div className="msgs-inner-wrap" style={{ maxWidth: '1200px', width: '100%', margin: '0 auto', padding: '2rem 4rem 1.5rem', display: 'flex', flexDirection: 'column', gap: '1.5rem', flex: 1, minHeight: 0 }}>
        ...
        <div className="msgs-panels">
          ...
          {/* ── LEFT SIDEBAR ── */}
          <div className={`msgs-panel-sidebar${mobShowChat ? ' mob-hidden' : ''}`} style={{ background: 'var(--bg-card)', backdropFilter: 'blur(20px)', border: '1px solid var(--border)', borderRadius: '20px', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
            {/* Tab headers */}
              ...
              {sidebarTab === 'requests' ? (
                chatRequests.length === 0 ? (
                  ...
                  return (
                    <div
                      key={req.id}
                      onClick={() => { setActiveRequest(req); setActiveConvo(null); setMobShowChat(true) }}
                      style={{
                        padding: '0.75rem 1rem', borderRadius: '14px', cursor: 'pointer',
                        marginBottom: '0.25rem', position: 'relative',
          ...
          {/* ── RIGHT PANEL ── */}
          <div className={`msgs-panel-chat${mobShowChat ? ' mob-visible' : ''}`} style={{ background: 'var(--bg-card)', backdropFilter: 'blur(20px)', border: '1px solid var(--border)', borderRadius: '20px', display: 'flex', flexDirection: 'column', minHeight: 0, overflow: 'hidden', position: 'relative' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', height: '100%', animation: 'reqSlideIn 0.22s ease' }}>
                ...
                <div style={{ padding: '1rem 1.5rem 0.85rem', borderBottom: '1px solid var(--border)', flexShrink: 0 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.85rem' }}>
                    <button className="mob-chat-back"
                      onClick={() => setMobShowChat(false)}
                      style={{ width: '34px', height: '34px', borderRadius: '50%', border: '1px solid var(--border-hover)', background: 'var(--bg-card)', color: 'var(--text-muted)', cursor: 'pointer', display: 'none', alignItems: 'center', justifyContent: 'center', flexShrink: 0, transition: 'all 0.15s' }}
